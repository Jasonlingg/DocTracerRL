"""GRPO-trained Qwen2.5-1.5B policy — the headline result.
...
Run on the same GPU box used for training:
  CHECKPOINT_PATH=checkpoints/grpo_qwen_1.5b/final python scripts/run_eval.py \
...
class GRPOPolicy:
    ...
    def act(self, observation: str) -> str:
        ...
        logger.debug(f"GRPOPolicy action ({len(action)} chars): {action[:100]}...")
        return action
